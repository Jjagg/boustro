// ignore_for_file: public_member_api_docs,use_raw_strings,prefer_interpolation_to_compose_strings,prefer_adjacent_string_concatenation

import 'auto_format.dart';

/// Regex patterns used by Twitter. Useful as patterns for [FormatRule].
///
/// Ported from https://github.com/twitter/twitter-text/tree/65e7e00da383fb77f5ab7fe3c0dc26b724e14035/js/src/regexp.
///
/// This is a full port of all regexes from the twitter-text library, but only a
/// few are directly useful as a formatting rule pattern for boustro:
///
/// - [extractUrl]
/// - [validHashtag]
/// - [validMention]
...
class TwitterPatterns {
  TwitterPatterns._();

  static const String astralLetterAndMarks =
      r'\ud800[\udc00-\udc0b\udc0d-\udc26\udc28-\udc3a\udc3c\udc3d\udc3f-\udc4d\udc50-\udc5d\udc80-\udcfa\uddfd\ude80-\ude9c\udea0-\uded0\udee0\udf00-\udf1f\udf30-\udf40\udf42-\udf49\udf50-\udf7a\udf80-\udf9d\udfa0-\udfc3\udfc8-\udfcf]|\ud801[\udc00-\udc9d\udd00-\udd27\udd30-\udd63\ude00-\udf36\udf40-\udf55\udf60-\udf67]|\ud802[\udc00-\udc05\udc08\udc0a-\udc35\udc37\udc38\udc3c\udc3f-\udc55\udc60-\udc76\udc80-\udc9e\udd00-\udd15\udd20-\udd39\udd80-\uddb7\uddbe\uddbf\ude00-\ude03\ude05\ude06\ude0c-\ude13\ude15-\ude17\ude19-\ude33\ude38-\ude3a\ude3f\ude60-\ude7c\ude80-\ude9c\udec0-\udec7\udec9-\udee6\udf00-\udf35\udf40-\udf55\udf60-\udf72\udf80-\udf91]|\ud803[\udc00-\udc48]|\ud804[\udc00-\udc46\udc7f-\udcba\udcd0-\udce8\udd00-\udd34\udd50-\udd73\udd76\udd80-\uddc4\uddda\ude00-\ude11\ude13-\ude37\udeb0-\udeea\udf01-\udf03\udf05-\udf0c\udf0f\udf10\udf13-\udf28\udf2a-\udf30\udf32\udf33\udf35-\udf39\udf3c-\udf44\udf47\udf48\udf4b-\udf4d\udf57\udf5d-\udf63\udf66-\udf6c\udf70-\udf74]|\ud805[\udc80-\udcc5\udcc7\udd80-\uddb5\uddb8-\uddc0\ude00-\ude40\ude44\ude80-\udeb7]|\ud806[\udca0-\udcdf\udcff\udec0-\udef8]|\ud808[\udc00-\udf98]|\ud80c[\udc00-\udfff]|\ud80d[\udc00-\udc2e]|\ud81a[\udc00-\ude38\ude40-\ude5e\uded0-\udeed\udef0-\udef4\udf00-\udf36\udf40-\udf43\udf63-\udf77\udf7d-\udf8f]|\ud81b[\udf00-\udf44\udf50-\udf7e\udf8f-\udf9f]|\ud82c[\udc00\udc01]|\ud82f[\udc00-\udc6a\udc70-\udc7c\udc80-\udc88\udc90-\udc99\udc9d\udc9e]|\ud834[\udd65-\udd69\udd6d-\udd72\udd7b-\udd82\udd85-\udd8b\uddaa-\uddad\ude42-\ude44]|\ud835[\udc00-\udc54\udc56-\udc9c\udc9e\udc9f\udca2\udca5\udca6\udca9-\udcac\udcae-\udcb9\udcbb\udcbd-\udcc3\udcc5-\udd05\udd07-\udd0a\udd0d-\udd14\udd16-\udd1c\udd1e-\udd39\udd3b-\udd3e\udd40-\udd44\udd46\udd4a-\udd50\udd52-\udea5\udea8-\udec0\udec2-\udeda\udedc-\udefa\udefc-\udf14\udf16-\udf34\udf36-\udf4e\udf50-\udf6e\udf70-\udf88\udf8a-\udfa8\udfaa-\udfc2\udfc4-\udfcb]|\ud83a[\udc00-\udcc4\udcd0-\udcd6]|\ud83b[\ude00-\ude03\ude05-\ude1f\ude21\ude22\ude24\ude27\ude29-\ude32\ude34-\ude37\ude39\ude3b\ude42\ude47\ude49\ude4b\ude4d-\ude4f\ude51\ude52\ude54\ude57\ude59\ude5b\ude5d\ude5f\ude61\ude62\ude64\ude67-\ude6a\ude6c-\ude72\ude74-\ude77\ude79-\ude7c\ude7e\ude80-\ude89\ude8b-\ude9b\udea1-\udea3\udea5-\udea9\udeab-\udebb]|\ud840[\udc00-\udfff]|\ud841[\udc00-\udfff]|\ud842[\udc00-\udfff]|\ud843[\udc00-\udfff]|\ud844[\udc00-\udfff]|\ud845[\udc00-\udfff]|\ud846[\udc00-\udfff]|\ud847[\udc00-\udfff]|\ud848[\udc00-\udfff]|\ud849[\udc00-\udfff]|\ud84a[\udc00-\udfff]|\ud84b[\udc00-\udfff]|\ud84c[\udc00-\udfff]|\ud84d[\udc00-\udfff]|\ud84e[\udc00-\udfff]|\ud84f[\udc00-\udfff]|\ud850[\udc00-\udfff]|\ud851[\udc00-\udfff]|\ud852[\udc00-\udfff]|\ud853[\udc00-\udfff]|\ud854[\udc00-\udfff]|\ud855[\udc00-\udfff]|\ud856[\udc00-\udfff]|\ud857[\udc00-\udfff]|\ud858[\udc00-\udfff]|\ud859[\udc00-\udfff]|\ud85a[\udc00-\udfff]|\ud85b[\udc00-\udfff]|\ud85c[\udc00-\udfff]|\ud85d[\udc00-\udfff]|\ud85e[\udc00-\udfff]|\ud85f[\udc00-\udfff]|\ud860[\udc00-\udfff]|\ud861[\udc00-\udfff]|\ud862[\udc00-\udfff]|\ud863[\udc00-\udfff]|\ud864[\udc00-\udfff]|\ud865[\udc00-\udfff]|\ud866[\udc00-\udfff]|\ud867[\udc00-\udfff]|\ud868[\udc00-\udfff]|\ud869[\udc00-\uded6\udf00-\udfff]|\ud86a[\udc00-\udfff]|\ud86b[\udc00-\udfff]|\ud86c[\udc00-\udfff]|\ud86d[\udc00-\udf34\udf40-\udfff]|\ud86e[\udc00-\udc1d]|\ud87e[\udc00-\ude1d]|\udb40[\udd00-\uddef]';
  static const String astralNumerals =
      r'\ud801[\udca0-\udca9]|\ud804[\udc66-\udc6f\udcf0-\udcf9\udd36-\udd3f\uddd0-\uddd9\udef0-\udef9]|\ud805[\udcd0-\udcd9\ude50-\ude59\udec0-\udec9]|\ud806[\udce0-\udce9]|\ud81a[\ude60-\ude69\udf50-\udf59]|\ud835[\udfce-\udfff]';
  static const String atSigns = '[@＠]';
  static const String bmpLetterAndMarks =
  ...
  static const String bmpNumerals =
      r'0-9\u0660-\u0669\u06f0-\u06f9\u07c0-\u07c9\u0966-\u096f\u09e6-\u09ef\u0a66-\u0a6f\u0ae6-\u0aef\u0b66-\u0b6f\u0be6-\u0bef\u0c66-\u0c6f\u0ce6-\u0cef\u0d66-\u0d6f\u0de6-\u0def\u0e50-\u0e59\u0ed0-\u0ed9\u0f20-\u0f29\u1040-\u1049\u1090-\u1099\u17e0-\u17e9\u1810-\u1819\u1946-\u194f\u19d0-\u19d9\u1a80-\u1a89\u1a90-\u1a99\u1b50-\u1b59\u1bb0-\u1bb9\u1c40-\u1c49\u1c50-\u1c59\ua620-\ua629\ua8d0-\ua8d9\ua900-\ua909\ua9d0-\ua9d9\ua9f0-\ua9f9\uaa50-\uaa59\uabf0-\uabf9\uff10-\uff19';
  static const String cashtag = '[a-zA-Z]{1,6}(?:[._][a-zA-Z]{1,2})?';
  static const String codePoint =
      r'(?:[^\uD800-\uDFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF])';
  static const String cyrillicLettersAndMarks = r'\u0400-\u04FF';
  static const String directionalMarkersGroup =
      r'\u202A-\u202E\u061C\u200E\u200F\u2066\u2067\u2068\u2069';
  static const String endHashtagMatch = '^(?:$hashSigns|:\\/\\/)';
  static const String endMentionMatch =
      '^(?:#{atSigns}|[#{latinAccentChars}]|:\\/\\/)';
  static final RegExp extractUrl = RegExp(
    '(' + // $1 total match
  ...
  static const String hashSigns = '[#＃]';
  static const String hashtagAlpha =
      '(?:[$bmpLetterAndMarks]|(?=$nonBmpCodePairs)(?:$astralLetterAndMarks))';
  static const String hashtagAlphaNumeric =
      '(?:[$bmpLetterAndMarks$bmpNumerals$hashtagSpecialChars]|(?=$nonBmpCodePairs)(?:$astralLetterAndMarks|$astralNumerals))';
  static const String hashtagBoundary =
      '?:^|\\uFE0E|\\uFE0F|\$|(?!$hashtagAlphaNumeric|&)$codePoint';
  static const String hashtagSpecialChars =
      r'_\u200c\u200d\ua67e\u05be\u05f3\u05f4\uff5e\u301c\u309b\u309c\u30a0\u30fb\u3003\u0f0b\u0f0c\xb7';
  static const String invalidChars = '[$invalidCharsGroup]';
  static const String invalidCharsGroup = r'\uFFFE\uFEFF\uFFFF';
  static const String invalidDomainChars =
      '$punct$spacesGroup$invalidCharsGroup$directionalMarkersGroup';
  static const String invalidUrlWithoutProtocolPrecedingChars = r'[-_.\/]$';
  static const String latinAccentChars =
      r'\xC0-\xD6\xD8-\xF6\xF8-\xFF\u0100-\u024F\u0253\u0254\u0256\u0257\u0259\u025B\u0263\u0268\u026F\u0272\u0289\u028B\u02BB\u0300-\u036F\u1E00-\u1EFF';
  static const String nonBmpCodePairs = r'[\uD800-\uDBFF][\uDC00-\uDFFF]/';
  static const String punct = r"\!'#%&'\(\)*\+,\\\-\.\/:;<=>\?@\[\]\^_{|}~\$";
  static const String rtlChars =
      r'[\u0600-\u06FF]|[\u0750-\u077F]|[\u0590-\u05FF]|[\uFE70-\uFEFF]';
  static const String spaces = '[$spacesGroup]';
  static const String spacesGroup =
      r'\x09-\x0D\x20\x85\xA0\u1680\u180E\u2000-\u200A\u2028\u2029\u202F\u205F\u3000';
  static final RegExp urlHasHttps =
      RegExp(r'^https:\/\/', caseSensitive: false);
  static final RegExp validAsciiDomain = RegExp(
      '(?:(?:[\\-a-z0-9$latinAccentChars]+)\\.)+(?:$validGTLD|$validCCTLD|$validPunycode)',
      caseSensitive: false);
  static const String validCCTLD = '(?:(?:' +
      ...
      ')(?=[^0-9a-zA-Z@+-]|\$))';
  static final RegExp validCashtag = RegExp(
      '(^|$spaces)(\\\$)($cashtag)(?=\$|\\s|[$punct])',
      caseSensitive: false);
  static const String validDomain =
      '(?:$validSubdomain*$validDomainName(?:$validGTLD|$validCCTLD|$validPunycode))';
  static const String validDomainChars = '[^$invalidDomainChars]';
  static const String validDomainName =
      '(?:(?:$validDomainChars(?:-|$validDomainChars)*)?$validDomainChars\\.)';
  static const String validGTLD = '(?:(?:' +
      ...
      'onion' +
      ')(?=[^0-9a-zA-Z@+-]|\$))';
  static const String validGeneralUrlPathChars =
  ...
  static final RegExp validHashtag = RegExp(
      ...
      caseSensitive: false);
  static final RegExp validMention =
      RegExp('($validMentionPrecedingChars)' + // $1: Preceding character
          '($atSigns)' + // $2: At mark
          '([a-zA-Z0-9_]{1,20})'); // $3: Screen name'
  static final RegExp validMentionOrList =
      RegExp('($validMentionPrecedingChars)' + // $1: Preceding character
          '($atSigns)' + // $2: At mark
          '([a-zA-Z0-9_]{1,20})' + // $3: Screen name'
          '(/[a-zA-Z][a-zA-Z0-9_-]{0,24})?'); // $4: List (optional)
  static const String validMentionPrecedingChars =
      r'(?:^|[^a-zA-Z0-9_!#$%&*@＠]|(?:^|[^a-zA-Z0-9_+~.-])(?:rt|RT|rT|Rt):?)';
  static const String validPortNumber = '[0-9]+';
  static const String validPunycode = r'(?:xn--[\-0-9a-z]+)';
  static const String validReply = '^(?:$spaces)*$atSigns([a-zA-Z0-9_]{1,20})';
  static const String validSubdomain =
      '(?:(?:$validDomainChars(?:[_-]|$validDomainChars)*)?$validDomainChars\\.)';
  static final RegExp validTcoUrl = RegExp(
      '^https?:\\/\\/t\\.co\\/([a-z0-9]+)(?:\\?#{validUrlQueryChars}*#{validUrlQueryEndingChars})?',
      caseSensitive: false);
  static const String validUrlBalancedParens = r'\(' +
      '(?:' +
      ...
      ')' +
      '\\)';
  static const String validUrlPath = '(?:' +
      '(?:' +
      '$validGeneralUrlPathChars*' +
      ...
      ')|(?:@$validGeneralUrlPathChars+/)' +
      ')';
  static const String validUrlPathEndingChars =
      '[\\+\\-a-z${cyrillicLettersAndMarks}0-9=_#\\/$latinAccentChars]|(?:$validUrlBalancedParens)';
  static const String validUrlPrecedingChars =
      '(?:[^A-Za-z0-9@＠\$#＃$invalidCharsGroup]|[$directionalMarkersGroup]|^)';
  static const String validUrlQueryChars =
      r"[a-z0-9!?\*'@\(\);:&=\+\$\/%#\[\]\-_\.,~|]";
  static const String validUrlQueryEndingChars = r'[a-z0-9\-_&=#\/]';
  static const String validateUrlAuthority = '(?:(#{validateUrlUserinfo})@)?' +
      // $2 host
      '(#{validateUrlHost})' +
      // $3 port
      '(?::(#{validateUrlPort}))?';
  static const String validateUrlDecOctet =
      '(?:[0-9]|(?:[1-9][0-9])|(?:1[0-9]{2})|(?:2[0-4][0-9])|(?:25[0-5]))';
  static const String validateUrlDomain =
      '(?:(?:$validateUrlSubDomainSegment\\.)*(?:$validateUrlDomainSegment\\.)$validateUrlDomainTld)';
  static const String validateUrlDomainSegment =
      r'(?:[a-z0-9](?:[a-z0-9\-]*[a-z0-9])?)';
  static const String validateUrlDomainTld =
      r'(?:[a-z](?:[a-z0-9\-]*[a-z0-9])?)';
  static const String validateUrlFragment = '($validateUrlPchar|\\/|\\?)*';
  static const String validateUrlHost = '(?:$validateUrlIp|$validateUrlDomain)';
  static const String validateUrlIp = '(?:$validateUrlIpv4|$validateUrlIpv6)';
  static const String validateUrlIpv4 =
      '(?:$validateUrlDecOctet(?:\\.$validateUrlDecOctet){3})';
  static const String validateUrlIpv6 = r'(?:\[[a-f0-9:\.]+\])';
  static const String validateUrlPath = '(\\/$validateUrlPchar*)*';
  static const String validateUrlPchar =
      '(?:$validateUrlUnreserved|$validateUrlPctEncoded|$validateUrlSubDelims|[:|@])';
  static const String validateUrlPctEncoded = '(?:%[0-9a-f]{2})';
  static const String validateUrlPort = '[0-9]{1,5}';
  static const String validateUrlQuery = '($validateUrlPchar|\\/|\\?)*';
  static const String validateUrlScheme = r'(?:[a-z][a-z0-9+\-.]*)';
  static const String validateUrlSubDelims = r"[!$&'()*+,;=]";
  static const String validateUrlSubDomainSegment =
      r'(?:[a-z0-9](?:[a-z0-9_\-]*[a-z0-9])?)';
  static const String validateUrlUnencoded = '^' + // Full URL
      '(?:' +
      '([^:/?#]+):\\/\\/' + // $1 Scheme
      ')?' +
      '([^/?#]*)' + // $2 Authority
      ...
      '#(.*)' + // $5 Fragment
      ')?\$';
  static const String validateUrlUnicodeAuthority =
      // $1 userinfo
      '(?:($validateUrlUserinfo)@)?' +
          // $2 host
          ...
          // $3 port
          '(?::($validateUrlPort))?';
  static const String validateUrlUnicodeDomain =
      '(?:(?:$validateUrlUnicodeSubDomainSegment\\.)*(?:validateUrlUnicodeDomainSegment\\.)$validateUrlUnicodeDomainTld)';
  static const String validateUrlUnicodeDomainSegment =
      r'(?:(?:[a-z0-9]|[^\u0000-\u007f])(?:(?:[a-z0-9\-]|[^\u0000-\u007f])*(?:[a-z0-9]|[^\u0000-\u007f]))?)';
  static const String validateUrlUnicodeDomainTld =
      r'(?:(?:[a-z]|[^\u0000-\u007f])(?:(?:[a-z0-9\-]|[^\u0000-\u007f])*(?:[a-z0-9]|[^\u0000-\u007f]))?)';
  static const String validateUrlUnicodeHost =
      '(?:$validateUrlIp|$validateUrlUnicodeDomain)';
  static const String validateUrlUnicodeSubDomainSegment =
      r'(?:(?:[a-z0-9]|[^\u0000-\u007f])(?:(?:[a-z0-9_\-]|[^\u0000-\u007f])*(?:[a-z0-9]|[^\u0000-\u007f]))?)';
  static const String validateUrlUnreserved = r'[a-z\u0400-\u04FF0-9\-._~]';
  static const String validateUrlUserinfo =
      '(?:$validateUrlUnreserved|$validateUrlPctEncoded|$validateUrlSubDelims|:)*';
}
