...
class Document extends Equatable {
  ...
  bool get isEmpty => _paragraphs.isEmpty;
  bool get isNotEmpty => _paragraphs.isNotEmpty;
...
abstract class Paragraph {
  ...
  /// Create a widget that displays this paragraph.
...
/// Interface for [Paragraph] implementations that contain text.
...
/// The [ParagraphController] for a [TextParagraphBase].
///
/// Paragraphs that contain rich text require an implementation of
/// [TextParagraphBase] and [TextParagraphControllerMixin].
///
/// This abstraction is important to `boustro`. It's used for all external
/// operations that modify text, for example, toggling a bold attribute.
